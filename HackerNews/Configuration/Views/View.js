...
itemElement.showComments.click.BindCommand(aas.Services.Browser.ClientService.DisplayItem('news', itemElement.ParentData.id));
itemElement.showUser.click.BindCommand(aas.Services.Browser.ClientService.DisplayUser(itemElement.ParentData.user));
...
askElement.showComments.click.BindCommand(aas.Services.Browser.ClientService.DisplayItem('ask', askElement.ParentData.id));
askElement.showUser.click.BindCommand(aas.Services.Browser.ClientService.DisplayUser( askElement.ParentData.user));
...
showElement.showComments.click.BindCommand(aas.Services.Browser.ClientService.DisplayItem('show', showElement.ParentData.id));
showElement.showUser.click.BindCommand(aas.Services.Browser.ClientService.DisplayUser(showElement.ParentData.user));
